...
public class LSHCosJob {
    ...
    private static final Log log = new Log(LSHCos.LSHCosJob.class);
    public static final String NUMHYPERPLANES = "numhyperplanes";

    public static void main(String[] args) throws Exception {

        Conf conf = new Conf(args, "sourcepath suspiciouspath output -v vocabulary -s vocsize --noninteractive");
