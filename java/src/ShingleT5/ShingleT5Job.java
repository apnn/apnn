 ...
 * @author Jeroen
 */
public class ShingleT5Job {

    private static final Log log = new Log(ShingleT5Job.class);
    
    public static void main(String[] args) throws Exception {

        Conf conf = new Conf(args, "sourcepath suspiciouspath output -v vocabulary --noninteractive");
        TestGenericJob.setAnnIndex(conf, ShingleT5.class);
        TestGenericJob.setContentExtractor(conf, ContentExtractorPAN.class);
