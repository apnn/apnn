 ...
 * @author jeroen
 */
public class TestGenericMapTerms extends Mapper<Integer, Pair, Text, Candidate> {

    public static final Log log = new Log(TestGenericMapTerms.class);
    protected Conf conf;
    ...
    public void setup(Context context) throws IOException {
        ...
        Document.setContentExtractor(getContentExtractor());
    }
    ...
    public ContentExtractor getContentExtractor() {
        return TestGenericJob.getContentExtractor(conf);
    }
    ...
    public void map(Integer key, Pair value, Context context) throws IOException, InterruptedException {
        ...
        log.info("inputfile %s", value.sourcefile);
