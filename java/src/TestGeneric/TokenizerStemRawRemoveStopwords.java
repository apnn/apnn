 ...
 * @author Jeroen
 */
public class TokenizerStemRawRemoveStopwords extends Tokenizer {

    public static Log log = new Log(TokenizerStemRawRemoveStopwords.class);

    public TokenizerStemRawRemoveStopwords() {
        super();
