 ...
 * @author Jeroen
 */
public class CanopyNYTJob2 extends CanopyGenericJob {

    private static final Log log = new Log(CanopyNYTJob2.class);
    ...
    public static void main(String[] args) throws Exception {
        ...
        CanopyNYTJob2 job = new CanopyNYTJob2(conf,
                conf.get("source"),
                conf.get("output"),
                conf.get("vocabulary"));
    ...
    public CanopyNYTJob2(Conf conf, String collection, String output, String vocabulary) throws IOException, ClassNotFoundException {
        super(conf, collection, collection, output, vocabulary);
    }
}
